...
#import "zp01hxdl_vjfltWMMenuView.h"
#import "zp01hxdl_vjfltWMScrollView.h"
...
extern NSString *const zp01hxdl_vjfltWMControllerDidAddToSuperViewNotification;
extern NSString *const zp01hxdl_vjfltWMControllerDidFullyDisplayedNotification;
 ...
 */
- (NSInteger)numbersOfChildControllersInPageController:(zp01hxdl_vjfltWMPageController *)pageController;
 ...
 */
- (__kindof UIViewController *)pageController:(zp01hxdl_vjfltWMPageController *)pageController viewControllerAtIndex:(NSInteger)index;
 ...
 */
- (NSString *)pageController:(zp01hxdl_vjfltWMPageController *)pageController titleAtIndex:(NSInteger)index;
 ...
 */
- (CGRect)pageController:(zp01hxdl_vjfltWMPageController *)pageController preferredFrameForContentView:(zp01hxdl_vjfltWMScrollView *)contentView;
 ...
 */
- (CGRect)pageController:(zp01hxdl_vjfltWMPageController *)pageController preferredFrameForMenuView:(zp01hxdl_vjfltWMMenuView *)menuView;
 ...
 */
- (void)pageController:(zp01hxdl_vjfltWMPageController *)pageController lazyLoadViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(zp01hxdl_vjfltWMPageController *)pageController willCachedViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(zp01hxdl_vjfltWMPageController *)pageController willEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;
 ...
 *  @param info           A dictionary that includes some infos, such as: `index` / `title`
 */
- (void)pageController:(zp01hxdl_vjfltWMPageController *)pageController didEnterViewController:(__kindof UIViewController *)viewController withInfo:(NSDictionary *)info;

@end

@interface zp01hxdl_vjfltWMPageController : TMViewController <WMMenuViewDelegate, WMMenuViewDataSource, UIScrollViewDelegate, WMPageControllerDataSource, WMPageControllerDelegate>
...
/** 顶部导航栏 */
@property (nonatomic, nullable, weak) zp01hxdl_vjfltWMMenuView *menuView;

/** 内部容器 */
@property (nonatomic, nullable, weak) zp01hxdl_vjfltWMScrollView *scrollView;
